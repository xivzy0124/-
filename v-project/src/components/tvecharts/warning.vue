...
const allAlertData = ref([
  ...
  { 
    // 🔴 High: 寒潮冻害 -> 绝收断货 -> 没货卖
    level: 'high', typeName: map.high, 
    message: '寒潮预警：河南产区明后天将迎强降温，田头无法采收，预计断货3天。', 
